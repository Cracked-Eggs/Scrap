<<<<<<< HEAD:Scrap/Scrap/Assets/Scripts/KOTH Mode Related Scripts/PlayerHealth_Koth.cs
using Photon.Pun;
...
>>>>>>> origin/CommitURP:Scrap/Assets/Scripts/KOTH Mode Related Scripts/PlayerHealth_Koth.cs
}
